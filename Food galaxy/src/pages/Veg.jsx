...
import { getVegData } from '../Api/VegApi'
...
const Veg = () => {
  ...
  return (
    <div className='min-h-screen bg-gray-100 py-10 '>
      ...
      <h1 className='text-4xl font-extrabold text-center mb-12 mt-6.5 text-green-700 tracking-tight'>
        🥬 Veg Dishes
      </h1>
          ...
          return (
            ...
            >
              ...
              <div className="relative">
                ...
                />
                <div className="absolute top-3 right-3 bg-white/90 backdrop-blur-sm px-2 py-1 rounded-lg text-xs font-bold text-green-600 shadow">
                  100% Veg
                </div>
              </div>
              ...
              <div className='p-6 text-center'>
                <h2 className='text-xl text-gray-800 font-bold mb-4 line-clamp-1'>
                  {val.strMeal}
                </h2>
